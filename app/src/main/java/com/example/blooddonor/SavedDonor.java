...
public class SavedDonor extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        DonorsRef = FirebaseDatabase.getInstance().getReference().child("SavedDonors").child(currentUserId);

        //RECYCLER VIEW FOR QUERY UPDATE(OPEN)

        donorList = (RecyclerView) findViewById(R.id.all_saved_donor_list);
    ...
    {
        Query query = FirebaseDatabase.getInstance().getReference().child("SavedDonors").child(currentUserId).limitToLast(50);
            ...
            protected void onBindViewHolder(@NonNull DonorActivity.DonorsViewHolder holder, @SuppressLint("RecyclerView") final int position, @NonNull Donor model)
            {
                ...
                holder.mView.setOnClickListener(new View.OnClickListener()
                {
                    ...
                    public void onClick(View v)
                    {
                        ...
                        Intent teacherProfileIntent = new Intent(SavedDonor.this,SavedDonorsProfileActivity.class);
